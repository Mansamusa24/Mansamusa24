...
Uses the user's own photos as backgrounds with bold caption text baked in,
...
def make_frame(out_name, src_name, text, colour, max_size, y_frac=0.78, darken_top=False, branding=False):
...
make_frame("01.jpg", "01_hollywood.jpg",
           "I DIDN'T START TRADING FOR MONEY.", WHITE, 100, y_frac=0.80, darken_top=True)

make_frame("02.jpg", "02_car.jpg",
           "I STARTED FOR FREEDOM.", GOLD, 120, y_frac=0.80)

make_frame("03.jpg", "03_pier.jpg",
           "TIME. LOCATION. NO BOSS. NO LIMITS.", WHITE, 90, y_frac=0.78)

make_frame("04.jpg", "04_horizon.jpg",
           "MARKET STRUCTURE IS HOW I GOT HERE.", GOLD, 90, y_frac=0.62, branding=True)
